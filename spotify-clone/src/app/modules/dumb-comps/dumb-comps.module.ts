...
@NgModule({
  declarations: [TrackComponent, GreetingComponent, IconWithNameComponent,HeaderAlbumPlaylistComponent],
  imports: [CommonModule, MatIconModule],
  exports: [TrackComponent, GreetingComponent, IconWithNameComponent,HeaderAlbumPlaylistComponent],
})
